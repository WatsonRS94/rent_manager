...
class Admin::UsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_user" do
    assert_difference('Admin::User.count') do
      post admin_users_url, params: { admin_user: { active: @admin_user.active, admin: @admin_user.admin, email: @admin_user.email, name: @admin_user.name, password: @admin_user.password } }
    end
  ...
  test "should update admin_user" do
    patch admin_user_url(@admin_user), params: { admin_user: { active: @admin_user.active, admin: @admin_user.admin, email: @admin_user.email, name: @admin_user.name, password: @admin_user.password } }
